 ...
 */
class JsonDump extends Input implements \Duf\Renderer\IFieldWidgetRenderer
{
	...
	public static function renderFieldWidget(\Duf\Form $form, $template_engine, $widget_conf, $group_id, $field_id, $field_conf)
	{
		...
		if ($value === null && !empty($field_conf['null_value'])) {
			...
			echo json_encode($value, JSON_HEX_TAG | JSON_HEX_AMP | JSON_NUMERIC_CHECK | JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
		}
		echo "</pre>\n";
	}
