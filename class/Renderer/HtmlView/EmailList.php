...
/**
 * Render list of e-mail addresses (a bit obfuscated)
 */
class EmailList extends Input implements \Duf\Renderer\IFieldWidgetRenderer
{
	...
	public static function renderFieldWidget(\Duf\Form $form, $template_engine, $widget_conf, $group_id, $field_id, $field_conf)
	{
		...
		foreach ($value as $email) {
			echo "<li>",
				str_replace(array('@', '.'), array('<span>&#64;</span>', '<span>&#46;</span>'), htmlspecialchars($email));
				"</li>\n";
		}
