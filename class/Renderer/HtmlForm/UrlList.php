 ...
 * Render URL list.
 */
class UrlList extends TextArea implements \Duf\Renderer\IFieldWidgetRenderer
{
	...
	public static function renderFieldWidget(\Duf\Form $form, $template_engine, $widget_conf, $group_id, $field_id, $field_conf)
	{
		...
		echo "<div class=\"textarea_note\">", _('Enter list of addresses, each address on its own line.'), "</div>";
