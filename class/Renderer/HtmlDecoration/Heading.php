...
/**
 * Render heading tag around some widgets.
 */
class Heading implements \Duf\Renderer\IWidgetRenderer
{

	/// @copydoc \Duf\Renderer\IWidgetRenderer::renderWidget
	public static function renderWidget(\Duf\Form $form, $template_engine, $widget_conf)
	{
		$level = (int) (isset($widget_conf['level']) ? $widget_conf['level'] : 3);
		$holder_tag = "h$level";
		...
		} else if (isset($widget_conf['text'])) {
			echo $widget_conf['text'];
		}
