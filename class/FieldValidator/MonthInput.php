...
/**
 * Validate HTML5 `<input type="month">`.
 */
class MonthInput extends DateTimeInput implements IFieldValidator
{
	/**
	 * Expected format.
	 */
	...
	{
		return _('Please use "YYYY-MM" format (ISO 8601, year and month).');
	}
